    ...
    peek: {
      ...
      group: {
        ...
        aggregationDialog: {
          ...
          sum: '合計（メンバーの数値を合算する）',
          formula: '数式（A, B, C...の変数を使って自由に組み立てる）',
          formulaLabel: '数式',
          formulaHint:
            'メンバーの並び順に割り当てたA, B, C...の変数を使い、四則演算と括弧で式を組み立てます（例: A - B + 3）。',
          formulaPreview: '計算結果プレビュー',
          formulaInvalid:
            '式が不正か、いずれかのメンバーの値を数値として解釈できません（このままだと「等しい」の検証は常にNGになります）。',
          memberValuePending: '（読み込み中）',
